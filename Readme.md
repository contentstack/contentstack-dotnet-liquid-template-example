...
[Download All Content Types](https://github.com/contentstack/contentstack-dotnet-liquid-template-example/tree/master/Schema/schema.zip)
...
Open the .csproj file to see the project in VS and install Dependencies.
